...
class CZFGuidePageViewController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    fileprivate lazy var dismissButton: UIButton = {
        ...
        dismissButtonTemp.setImage(GuideManager.dismissButtonImage!, for: UIControlState.normal)
    ...
    override func viewDidLoad() {
        ...
        self.dismissButton.addTarget(self, action: #selector(dismissButtonClick(sender:)), for: UIControlEvents.touchUpInside)
